...
generateCRL(){
		fabric-ca-client revoke -e user1 --gencrl --tls.certfiles ${PWD}/../organizations/fabric-ca/org1/ca-cert.pem
		base64 -i ${PWD}/../organizations/peerOrganizations/org1.example.com/msp/crls/crl.pem | tr -d '\n'  >  base64Cert
}
